...
Lint.prototype.report = function () {
  ...
  if (this.results.length === 0) {
    ...
    report.push(util.format("\n%d %s in %d %s".red, this.results.length, pluralize('error', this.results.length), this.count, pluralize('file', this.count)));
  }
